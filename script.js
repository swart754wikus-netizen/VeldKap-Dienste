...
const catalog = {
  ...
  spareparts: {
    ...
    photoPosition: "50% 55%",
    items: [
      { slug: "spares-trimmer-head", brand: "Husky", model: "Aluminium Trimmer Head", price: "R51", description: ["21.5mm aluminium trimmer head, low-cut."], idealFor: [], features: [] },
      { slug: "spares-grease", brand: "Husky", model: "Grease (120g)", price: "R63", description: ["120g grease tube for brush cutter and trimmer gearboxes."], idealFor: [], features: [] },
      { slug: "spares-sae40-oil", brand: "Husky", model: "SAE40 4-Stroke Engine Oil (500ml)", price: "R71", description: ["SAE40 oil for 4-stroke petrol engines."], idealFor: [], features: [] },
      { slug: "spares-2stroke-oil", brand: "Husky", model: "2-Stroke Engine Oil (1L)", price: "R114", description: ["2-stroke petrol engine oil for brush cutters, trimmers and blowers."], idealFor: [], features: [] },
      { slug: "spares-chainsaw-oil", brand: "Husky", model: "Chainsaw Bar & Chain Oil (1L)", price: "R117", description: ["Virgin cutterbar oil for chainsaws."], idealFor: [], features: [] },
      { slug: "spares-trimmer-line", brand: "Husky", model: "Nylon Trimmer Line (2.4mm, 2kg roll)", price: "R390", description: ["Orange nylon trimmer line, also available in 2.0mm, 2.7mm and 3.5mm, and as pre-cut lengths."], idealFor: [], features: [] },
      { slug: "spares-drill-bit-200", brand: "Tanaka", model: "Earth Auger Drill Bit (200mm)", price: "R452", description: ["Replacement earth auger drill bit, also available in 100mm, 150mm, 250mm and 300mm."], idealFor: [], features: [] },
      { slug: "stiletto-eng-tl52", brand: "Stiletto", model: "TL52 Replacement Engine", price: "R997", description: ["52cc, 1.45kW replacement engine for Stiletto brush cutters."], idealFor: [], features: [] },
      { slug: "tanaka-eng-tl52", brand: "Tanaka", model: "TL52 Replacement Engine", price: "R1,035", description: ["52cc, 1.45kW replacement engine for Tanaka brush cutters."], idealFor: [], features: [] },
      { slug: "bush-hog-eng-143r11", brand: "Bush Hog", model: "143R11 Replacement Engine", price: "R1,064", description: ["41.5cc, 1.47kW replacement engine for Bush Hog brush cutters."], idealFor: [], features: [] },
      { slug: "husky-eng-143r11a", brand: "Husky", model: "143R11A Replacement Engine", price: "R1,219", description: ["41cc, 1.55kW replacement engine for Husky brush cutters."], idealFor: [], features: [] },
      { slug: "kudu-trailing-seat", brand: "Kudu", model: "Econo Trailing Seat", price: "R7,590", description: ["Trailing seat accessory for Kudu and Tuffking industrial mowers, lets the operator sit while mowing."], idealFor: [], features: [] },
    ],
  },
};
